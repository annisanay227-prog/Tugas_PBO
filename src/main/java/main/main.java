...
public class main {
    ...
    public static void main(String[] args) {
        ...
        while (berjalan) {
            ...
            System.out.println(
                    "   SISTEM MANAJEMEN FASILITAS & PENDATAAN POSYANDU"
            );
            ...
            System.out.println(
                    "1. Kelola Pendataan Alat Posyandu"
            );

            System.out.println(
                    "2. Kelola Rencana Pengadaan Fasilitas"
            );
        ...
        while (!kembali) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    System.out.print(
                            "Masukkan ID Alat (contoh: ALT-003): "
                    );
                    ...
                    System.out.print(
                            "Masukkan Kondisi (Baik/Perlu Kalibrasi/Rusak): "
                    );
    ...
    private static void menuPengadaan() {
        ...
        while (!kembali) {
            ...
            System.out.println(
                    "1. Tampilkan Semua Pengadaan"
            );

            System.out.println(
                    "2. Tambah Rencana Pengadaan"
            );

            System.out.println(
                    "3. Update Status Pengadaan"
            );

            System.out.println(
                    "4. Hapus Rencana Pengadaan"
            );
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    System.out.print(
                            "Masukkan ID Pengadaan (contoh: PGD-002): "
                    );
                    ...
                    int jumlah = inputInteger(
                            "Masukkan Jumlah Dibutuhkan: "
                    );

                    double biaya = inputDouble(
                            "Masukkan Estimasi Biaya (Rp): "
                    );

                    System.out.print(
                            "Masukkan Status (Diajukan/Disetujui/Proses): "
                    );

                    String status = scanner.nextLine();

                    sistem.tambahPengadaan(
                            new PengadaanFasilitas(
                                    id,
                                    nama,
                                    jumlah,
                                    biaya,
                ...
                case 3:
                    ...
                    System.out.print(
                            "Masukkan ID Pengadaan yang diupdate: "
                    );
                    ...
                    if (sistem.cariPengadaanById(idEdit) != null) {
                        ...
                        System.out.print(
                                "Status Baru (Diajukan/Disetujui/Ditolak/Selesai): "
                        );

                        String statusBaru = scanner.nextLine();

                        sistem.updateStatusPengadaan(
                                idEdit,
                                statusBaru
                        );
                ...
                case 4:
                    ...
                    System.out.print(
                            "Masukkan ID Pengadaan yang ingin dihapus: "
                    );
    ...
    private static double inputDouble(String pesan) {
        ...
        while (true) {
            ...
            try {
                ...
                double angka = Double.parseDouble(
                        scanner.nextLine().trim()
                );
                ...
                System.out.println(
                        "[Error] Input harus berupa angka desimal/nominal!"
                );
            }
        }
    }
