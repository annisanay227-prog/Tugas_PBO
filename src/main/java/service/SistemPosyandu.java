...
public class SistemPosyandu {
    ...
    public void tambahAlat(AlatPosyandu alat) {
        ...
        if (alat == null) {
            System.out.println("[!] Data alat tidak boleh kosong.");
            return;
        }
        ...
        System.out.println(
                "[+] Berhasil menambahkan data alat kesehatan baru."
        );
    }
    ...
    public void tambahPengadaan(PengadaanFasilitas pengadaan) {
        ...
        if (pengadaan == null) {
            System.out.println(
                    "[!] Data pengadaan tidak boleh kosong."
            );
            return;
        }
        ...
        System.out.println(
                "[+] Berhasil menambahkan rencana pengadaan baru."
        );
    }
    ...
    public void tampilkanSemuaPengadaan() {
        ...
        if (daftarPengadaan.isEmpty()) {
            ...
            System.out.println(
                    "[!] Belum ada rencana pengadaan fasilitas."
            );
    ...
    public void updateStatusPengadaan(
            String id,
            String statusBaru) {
